...
if (!isset($_SESSION['u_id'])) {
       ...
       ?>>
        ...
        <p>Your Progress VS Mine is not your everyday fitness app.</p>
        ...
        <p>Here you can make up your schedule, keep track of your workouts and look for advice at the same time.</p>
      </div>
    </main>
  </div>
